...
Item {
    ...
    Text {
        x: 72
        y: 37
        text: "Sensör verilerini canlı izleyin"
        color: root.subText
        font.pixelSize: 11
    }
    ...
    Rectangle {
        ...
        Rectangle {
            ...
            Text {
                ...
                anchors.margins: 10
                text: vs.fingerPresent
                      ? "Sensör algılandı. Nabız ve SpO₂ değerleri izleniyor."
                      : "Sensörü takın. Değerler burada görüntülenecek."
                color: "#2A67E8"
                font.pixelSize: 12
                wrapMode: Text.WordWrap
            }
    ...
    Rectangle {
        ...
        Text {
            ...
            y: 46
            width: parent.width - 244
            text: "Nabız ve SpO₂ değerleri bu ekranda canlı izlenir."
            color: root.subText
            font.pixelSize: 13
            wrapMode: Text.WordWrap
        }
    ...
    Rectangle {
        ...
        Text {
            anchors.centerIn: parent
            text: "Ana sayfaya dönmek için üstteki butonu kullanın"
            color: root.pageText
            font.pixelSize: 16
            font.weight: Font.Medium
        }
