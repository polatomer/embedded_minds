// BleedingBodyLightScreen.qml — Vücutta Hafif Kanama
import QtQuick 2.15
GuidanceVideoScreen {
    scenarioFolder: "bleeding_body_light"
    steps: [
        {
        ...
        },
        {
            ...
            popup: {
                question: "Bası ile kanama kontrol altına alındı mı?",
                voiceCue: "q_bleeding_stopped",
                options: [
                    { text: "Evet, Yavaşladı",  nextStepId: "step_dress"    },
